...
>(({ className, children, showCloseButton = false, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 w-[420px] max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] rounded-xl bg-background border border-border shadow-2xl overflow-hidden",
...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "bg-background p-4 flex justify-end gap-2 rounded-b-xl",
      className,
    )}
    {...props}
  />
