    ...
    () => ({
      ...
      table: ({ children, ...props }: any) => (
        <div className="overflow-x-auto my-3 rounded-lg border border-border overflow-hidden">
          <table className={cn(styles.table, "border-collapse")} {...props}>{children}</table>
        </div>
      ),
...
const MemoizedMarkdownBlock = memo(
  function MemoizedMarkdownBlock({
    ...
    const components = useMemo(
      () => ({
        h1: ({ children, ...props }: any) => (
          <h1 className={h1Cls} {...props}>{children}</h1>
        ),
        h2: ({ children, ...props }: any) => (
          <h2 className={h2Cls} {...props}>{children}</h2>
        ),
        h3: ({ children, ...props }: any) => (
          <h3 className={h3Cls} {...props}>{children}</h3>
        ),
        h4: ({ children, ...props }: any) => (
          <h4 className={h4Cls} {...props}>{children}</h4>
        ),
        h5: ({ children, ...props }: any) => (
          <h5 className={h5Cls} {...props}>{children}</h5>
        ),
        h6: ({ children, ...props }: any) => (
          <h6 className={h6Cls} {...props}>{children}</h6>
        ),
        p: ({ children, ...props }: any) => (
          <p className={styles.p} {...props}>{children}</p>
        ),
